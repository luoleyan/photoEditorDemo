...
const verificationChecks = [
  {
    ...
    pattern: /import\s+AdapterFactory\s+from\s+['"]@\/components\/adapters\/AdapterFactory\.js['"];?/,
    required: true
  },
  {
  ...
  },
  {
    ...
    pattern: /v-else-if="integratedMode === 'brush' && integratedBrushAdapterInitialized && integratedBrushAdapter"/,
    required: true
  },
  {
