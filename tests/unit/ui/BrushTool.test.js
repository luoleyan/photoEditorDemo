...
global.HTMLCanvasElement.prototype.getBoundingClientRect = jest.fn(() => mockCanvas.getBoundingClientRect());
...
describe('BrushTool - 简化测试', () => {
  ...
  describe('错误处理', () => {
    ...
    test('应该在禁用状态下阻止操作', async () => {
      ...
      wrapper.vm.handleCanvasMouseDown({ clientX: 100, clientY: 100, preventDefault: jest.fn() });
      // 验证绘制状态没有改变
