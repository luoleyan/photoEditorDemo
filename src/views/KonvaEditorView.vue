      ...
      <div class="controls-panel">
        ...
        <div class="control-group">
          ...
          <div class="button-group">
            ...
            <button @click="testSpecificAngles" class="btn btn-warning">测试特定角度</button>
          </div>
        </div>
        ...
        <div class="control-group">
          <h4>动画效果</h4>
          <div class="button-group">
            <button @click="animateRotation" class="btn btn-secondary">旋转动画</button>
            <button @click="animateScale" class="btn btn-secondary">缩放动画</button>
            <button @click="animateBounce" class="btn btn-secondary">弹跳动画</button>
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="button-group">
            ...
            <button @click="resetStage" class="btn btn-secondary">重置舞台</button>
          </div>
        </div>
        ...
        <div class="control-group">
          <h4>图层操作</h4>
          <div class="button-group">
            <button @click="moveToTop" class="btn btn-secondary">移到顶层</button>
            <button @click="moveToBottom" class="btn btn-secondary">移到底层</button>
            <button @click="toggleVisibility" class="btn btn-secondary">切换可见性</button>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    syncControlsFromImage() {
      ...
      try {
        ...
        // 验证转换精度
        const validation = this.validateConversion(rotationRadians, rotationDegrees)
    ...
    applyFilters() {
      ...
      try {
        ...
        console.log('滤镜已应用:', { brightness: this.brightness, contrast: this.contrast })
    ...
    testRotation() {
      ...
      console.log('  4.712388980384690 对应角度:', this.radiansToDegrees(4.712388980384690) + '°')
      console.log('  π 值:', Math.PI)
      console.log('  270° × π/180 =', 270 * Math.PI / 180)

      console.log('🎯 图片属性:')
      console.log('  位置:', { x: this.currentImage.x(), y: this.currentImage.y() })
      console.log('  偏移:', { offsetX: this.currentImage.offsetX(), offsetY: this.currentImage.offsetY() })
      console.log('  尺寸:', { width: this.currentImage.width(), height: this.currentImage.height() })
